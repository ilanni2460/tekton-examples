...
func TestNewApp(t *testing.T) {
	...
	e.GET("/admin").WithBasicAuth("admin", "admin").Expect().
		Status(httptest.StatusOK).Body().Equal("/admin admin:admin")
	e.GET("/admin/profile").WithBasicAuth("admin", "admin").Expect().
		Status(httptest.StatusOK).Body().Equal("/admin/profile admin:admin")
	e.GET("/admin/settings").WithBasicAuth("admin", "admin").Expect().
		Status(httptest.StatusOK).Body().Equal("/admin/settings admin:admin")
